...
public class SolvedAnswers : MonoBehaviour
{
    ...
    public void AnswerA()
    {
        if (QuestionGenerator2.actualAnswer == "A")
        {
    ...
    public void AnswerB()
    {
        if (QuestionGenerator2.actualAnswer == "B")
        {
    ...
    public void AnswerC()
    {
        if (QuestionGenerator2.actualAnswer == "C")
        {
    ...
    public void AnswerD()
    {
        if (QuestionGenerator2.actualAnswer == "D")
        {
    ...
    IEnumerator NextQuestion()
    {
        ...
        QuestionGenerator2.displayingQuestion = false;
    }
}
